...
### Features to add
* Ideally a "simulation space" like Netlogo's behavior space, really just a way to coordinate lots of simulations
...
pars["pred_window"] = TRUE # Is size selective predation defined by a vulnerable window (FALSE = continuous size selectivity)
...
pars["pred_alpha_Inf"] = 2 # Predator preference to attack infected individuals, must be non-negative (1 = no preference)
```
